...
public class NewAcctActivity extends Activity {
	...
	public void newAcctDone(View view){
		...
		// Create new async task to execute network calls off the main
		// UI thread
		new AsyncTask<Void, Void, String>() {
			...
			protected void onPostExecute(String result){
				if(result.startsWith("0")){
					...
					Intent intent = new Intent(NewAcctActivity.this, MainActivity.class);
					intent.putExtra("android.wellness.MESSAGE", result);
